      ...
      <div class="col-lg-3 col-xxl-2">
        <div class="pt-3 px-4 d-lg-block" :class="{ 'd-none': isMenuHidden }">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link text-nowrap disabled"><i class="bi-boxes"></i> Inventory</a>
            </li>
            <li class="nav-item">
              <router-link :to="{name: 'stock'}" class="nav-link text-nowrap"><i class="bi-table"></i> Stock</router-link>
            </li>
            <li class="nav-item">
              <a class="nav-link text-nowrap disabled"><i class="bi-cart4"></i> Orders</a>
            </li>
            <li class="nav-item">
